...
| **SPEC-017 implemented**: direct AWS IAM authentication for Amazon MSK                                                   | **Implemented — validation on a real MSK Express cluster with the release package pending**                                             | [`SPEC-017`](./docs/specs/017-msk-iam-authentication.md)                         |
