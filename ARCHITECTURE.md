...
| **SPEC-017 verified**: direct AWS IAM authentication for Amazon MSK                                               | **Verified — automated gates and authorized read-only MSK Express metadata validation complete**                                          | [`SPEC-017`](./docs/specs/017-msk-iam-authentication.md)                         |
...
| **v2.0.0**      | Features beyond v1.0.0 scope: KsqlDB, audit log, Kafka Streams topology, advanced management, broker config write, relay pod and OAUTHBEARER. AWS MSK IAM was delivered by SPEC-017.                                                                                                                  | Unscheduled                           |
