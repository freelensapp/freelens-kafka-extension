...
| [SPEC-016](./016-msk-iam-authentication.md) | Implementing | REQ-206–REQ-209 | AWS IAM authentication for direct Amazon MSK connections |

The next available requirement ID is `REQ-210`. SPEC-007–014 allocate REQ-084–REQ-191 and define
